...
public class ArrayOfHostAssignableHardwareBinding implements java.io.Serializable {
    ...
    public HostAssignableHardwareBinding getHostAssignableHardwareBinding(int i) {
        return this.HostAssignableHardwareBinding[i];
    }

    public void setHostAssignableHardwareBinding(HostAssignableHardwareBinding[] HostAssignableHardwareBinding) {
        this.HostAssignableHardwareBinding = HostAssignableHardwareBinding;
    }
}
