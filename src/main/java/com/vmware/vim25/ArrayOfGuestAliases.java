...
public class ArrayOfGuestAliases implements java.io.Serializable {
    ...
    public GuestAliases[] GuestAliases;

    public GuestAliases[] getGuestAliases() {
        return this.GuestAliases;
    }

    public GuestAliases getGuestAliases(int i) {
        return this.GuestAliases[i];
    }

    public void setGuestAliases(GuestAliases[] GuestAliases) {
