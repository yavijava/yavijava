...
public class ArrayOfVsanNewPolicyBatch implements java.io.Serializable {
    ...
    public VsanNewPolicyBatch getVsanNewPolicyBatch(int i) {
        return this.VsanNewPolicyBatch[i];
    }

    public void setVsanNewPolicyBatch(VsanNewPolicyBatch[] VsanNewPolicyBatch) {
