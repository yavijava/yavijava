...
public class NvdimmNamespaceInfo extends DynamicData {
    ...
    @Getter @Setter public long blockSize;
    @Getter @Setter public long blockCount;
    @Getter @Setter public String type;
    @Getter @Setter public String namespaceHealthStatus;
    @Getter @Setter public int locationID;
