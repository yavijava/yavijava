...
public class ArrayOfHostConnectSpec implements java.io.Serializable {
    ...
    public HostConnectSpec getHostConnectSpec(int i) {
        return this.HostConnectSpec[i];
    }

    public void setHostConnectSpec(HostConnectSpec[] HostConnectSpec) {
        this.HostConnectSpec = HostConnectSpec;
    }
}
