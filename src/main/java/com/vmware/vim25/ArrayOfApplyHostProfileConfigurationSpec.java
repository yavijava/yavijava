...
public class ArrayOfApplyHostProfileConfigurationSpec implements java.io.Serializable {
    ...
    public ApplyHostProfileConfigurationSpec getApplyHostProfileConfigurationSpec(int i) {
        return this.ApplyHostProfileConfigurationSpec[i];
    }

    public void setApplyHostProfileConfigurationSpec(ApplyHostProfileConfigurationSpec[] ApplyHostProfileConfigurationSpec) {
