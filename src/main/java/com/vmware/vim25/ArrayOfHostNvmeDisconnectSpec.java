...
public class ArrayOfHostNvmeDisconnectSpec {
    ...
    public HostNvmeDisconnectSpec getHostNvmeDisconnectSpec(int i) {
        return this.HostNvmeDisconnectSpec[i];
    }

    public void setHostNvmeDisconnectSpec(HostNvmeDisconnectSpec[] HostNvmeDisconnectSpec) {
        this.HostNvmeDisconnectSpec = HostNvmeDisconnectSpec;
    }
}
