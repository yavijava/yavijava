...
public class NvdimmSummary extends DynamicData {
    @Getter @Setter public int numDimms;
    ...
    @Getter @Setter public long availableCapacity;
    @Getter @Setter public int numInterleavesets;
    @Getter @Setter public int numNamespaces;
}
