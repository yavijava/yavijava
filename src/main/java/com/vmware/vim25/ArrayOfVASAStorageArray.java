...
public class ArrayOfVASAStorageArray implements java.io.Serializable {
    ...
    public VASAStorageArray[] VASAStorageArray;

    public VASAStorageArray[] getVASAStorageArray() {
        return this.VASAStorageArray;
    }

    public VASAStorageArray getVASAStorageArray(int i) {
        return this.VASAStorageArray[i];
    }

    public void setVASAStorageArray(VASAStorageArray[] VASAStorageArray) {
