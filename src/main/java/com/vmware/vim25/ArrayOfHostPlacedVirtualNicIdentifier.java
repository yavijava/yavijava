...
public class ArrayOfHostPlacedVirtualNicIdentifier implements java.io.Serializable {
    ...
    public HostPlacedVirtualNicIdentifier getHostPlacedVirtualNicIdentifier(int i) {
        return this.HostPlacedVirtualNicIdentifier[i];
    }

    public void setHostPlacedVirtualNicIdentifier(HostPlacedVirtualNicIdentifier[] HostPlacedVirtualNicIdentifier) {
