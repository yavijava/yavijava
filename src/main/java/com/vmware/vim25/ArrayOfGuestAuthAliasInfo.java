...
public class ArrayOfGuestAuthAliasInfo {
    ...
    public GuestAuthAliasInfo getGuestAuthAliasInfo(int i) {
        return this.GuestAuthAliasInfo[i];
    }

    public void setGuestAuthAliasInfo(GuestAuthAliasInfo[] GuestAuthAliasInfo) {
