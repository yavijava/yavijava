...
public class ArrayOfVirtualMachineConnection implements java.io.Serializable {
    ...
    public VirtualMachineConnection getVirtualMachineConnection(int i) {
        return this.VirtualMachineConnection[i];
    }

    public void setVirtualMachineConnection(VirtualMachineConnection[] VirtualMachineConnection) {
        this.VirtualMachineConnection = VirtualMachineConnection;
    }
}
