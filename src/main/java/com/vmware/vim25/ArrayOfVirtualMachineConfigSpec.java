...
public class ArrayOfVirtualMachineConfigSpec {
    ...
    public VirtualMachineConfigSpec getVirtualMachineConfigSpec(int i) {
        return this.VirtualMachineConfigSpec[i];
    }

    public void setVirtualMachineConfigSpec(VirtualMachineConfigSpec[] VirtualMachineConfigSpec) {
        this.VirtualMachineConfigSpec = VirtualMachineConfigSpec;
    }
}
