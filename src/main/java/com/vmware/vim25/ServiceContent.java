...
public class ServiceContent extends DynamicData {
    ...
    @Getter @Setter public ManagedObjectReference guestCustomizationManager;
    ...
    @Getter @Setter public ManagedObjectReference tenantManager;
    @Getter @Setter public ManagedObjectReference siteInfoManager;
    @Getter @Setter public ManagedObjectReference storageQueryManager;
    @Getter @Setter public ManagedObjectReference directPathProfileManager;
}
