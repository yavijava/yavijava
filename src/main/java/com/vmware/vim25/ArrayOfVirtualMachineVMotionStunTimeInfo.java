...
public class ArrayOfVirtualMachineVMotionStunTimeInfo implements java.io.Serializable {
    ...
    public VirtualMachineVMotionStunTimeInfo getVirtualMachineVMotionStunTimeInfo(int i) {
        return this.VirtualMachineVMotionStunTimeInfo[i];
    }

    public void setVirtualMachineVMotionStunTimeInfo(VirtualMachineVMotionStunTimeInfo[] VirtualMachineVMotionStunTimeInfo) {
        this.VirtualMachineVMotionStunTimeInfo = VirtualMachineVMotionStunTimeInfo;
    }
}
