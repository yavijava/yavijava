...
public class ArrayOfCryptoManagerHostKeyStatus implements java.io.Serializable {
    ...
    public CryptoManagerHostKeyStatus getCryptoManagerHostKeyStatus(int i) {
        return this.CryptoManagerHostKeyStatus[i];
    }

    public void setCryptoManagerHostKeyStatus(CryptoManagerHostKeyStatus[] CryptoManagerHostKeyStatus) {
        this.CryptoManagerHostKeyStatus = CryptoManagerHostKeyStatus;
    }
}
