...
public class ArrayOfHostInternetScsiHbaIscsiIpv6Address implements java.io.Serializable {
    ...
    public HostInternetScsiHbaIscsiIpv6Address getHostInternetScsiHbaIscsiIpv6Address(int i) {
        return this.HostInternetScsiHbaIscsiIpv6Address[i];
    }

    public void setHostInternetScsiHbaIscsiIpv6Address(HostInternetScsiHbaIscsiIpv6Address[] HostInternetScsiHbaIscsiIpv6Address) {
