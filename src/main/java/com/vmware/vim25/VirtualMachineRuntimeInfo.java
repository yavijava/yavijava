...
public class VirtualMachineRuntimeInfo extends DynamicData {
    ...
    @Getter @Setter public Boolean vmFailoverInProgress;
    ...
    @Getter @Setter public Boolean instantCloneFrozen;
    @Getter @Setter public String cryptoState;
    @Getter @Setter public Boolean suspendedToMemory;
    @Getter @Setter public Long opNotificationTimeout;
    @Getter @Setter public Boolean iommuActive;
}
