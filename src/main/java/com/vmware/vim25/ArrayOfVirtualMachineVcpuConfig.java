...
public class ArrayOfVirtualMachineVcpuConfig {
    ...
    public VirtualMachineVcpuConfig getVirtualMachineVcpuConfig(int i) {
        return this.VirtualMachineVcpuConfig[i];
    }

    public void setVirtualMachineVcpuConfig(VirtualMachineVcpuConfig[] VirtualMachineVcpuConfig) {
        this.VirtualMachineVcpuConfig = VirtualMachineVcpuConfig;
    }
}
