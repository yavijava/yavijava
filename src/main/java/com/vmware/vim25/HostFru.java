...
public class HostFru extends DynamicData {
    ...
    @Getter @Setter public String partName;
    @Getter @Setter public String partNumber;
    @Getter @Setter public String manufacturer;
    @Getter @Setter public String serialNumber;
    @Getter @Setter public Calendar mfgTimeStamp;
}
