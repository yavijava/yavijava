...
public class ArrayOfVimVasaProviderInfo implements java.io.Serializable {
    ...
    public VimVasaProviderInfo[] VimVasaProviderInfo;

    public VimVasaProviderInfo[] getVimVasaProviderInfo() {
        return this.VimVasaProviderInfo;
    }

    public VimVasaProviderInfo getVimVasaProviderInfo(int i) {
        return this.VimVasaProviderInfo[i];
    }

    public void setVimVasaProviderInfo(VimVasaProviderInfo[] VimVasaProviderInfo) {
