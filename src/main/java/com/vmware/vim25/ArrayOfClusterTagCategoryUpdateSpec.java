...
public class ArrayOfClusterTagCategoryUpdateSpec implements java.io.Serializable {
    ...
    public ClusterTagCategoryUpdateSpec getClusterTagCategoryUpdateSpec(int i) {
        return this.ClusterTagCategoryUpdateSpec[i];
    }

    public void setClusterTagCategoryUpdateSpec(ClusterTagCategoryUpdateSpec[] ClusterTagCategoryUpdateSpec) {
        this.ClusterTagCategoryUpdateSpec = ClusterTagCategoryUpdateSpec;
    }
}
