...
public class IoFilterManager extends ManagedObject {
     ...
     */
    public Task installIoFilter_Task(String vibUrl, ComputeResource cluster) throws AlreadyExists, InvalidArgument,
                    RuntimeFault, RemoteException {
        return new Task(getServerConnection(), getVimService().installIoFilter_Task(getMOR(), vibUrl,
                        cluster == null ? null : cluster.getMOR()));
    }
     ...
     * @throws RemoteException
     */
    public Task unInstallIoFilter_Task(String filterId, ComputeResource cluster) throws FilterInUse, InvalidState,
                    NotFound, InvalidArgument, RuntimeFault, RemoteException {
        return new Task(getServerConnection(), getVimService().unInstallIoFilter_Task(getMOR(), filterId,
                        cluster == null ? null : cluster.getMOR()));
    }
     ...
     * @throws RemoteException
     */
    public Task upgradeIoFilter_Task(String filterId, ComputeResource cluster, String vibUrl) throws InvalidState,
                    NotFound, InvalidArgument, RuntimeFault, RemoteException {
        return new Task(getServerConnection(), getVimService().upgradeIoFilter_Task(getMOR(), filterId,
                        cluster == null ? null : cluster.getMOR(), vibUrl));
    }
     ...
     * @throws RemoteException
     */
    public Task resolveInstallationErrorsOnCluster_Task(String filterId, ComputeResource cluster) throws AlreadyExists,
                    InvalidArgument, RuntimeFault, RemoteException {
        return new Task(getServerConnection(), getVimService().resolveInstallationErrorsOnCluster_Task(getMOR(),
                        filterId, cluster == null ? null : cluster.getMOR()));
    }
     ...
     * @throws RemoteException
     */
    public Task resolveInstallationErrorsOnHost_Task(String filterId, HostSystem host) throws AlreadyExists,
                    InvalidArgument, RuntimeFault, RemoteException {
        return new Task(getServerConnection(), getVimService().resolveInstallationErrorsOnHost_Task(getMOR(), filterId,
     ...
     *             a communication error.
     */
    public ClusterIoFilterInfo[] queryIoFilterInfo(ComputeResource cluster) throws RemoteException, RuntimeFault {
        return getVimService().queryIoFilterInfo(getMOR(), cluster == null ? null : cluster.getMOR());
    }
     ...
     *             a communication error.
     */
    public VirtualDiskId[] queryDisksUsingFilter(String filterId, ComputeResource cluster) throws RemoteException,
                    RuntimeFault {
        return getVimService().queryDisksUsingFilter(getMOR(), filterId, cluster == null ? null : cluster.getMOR());
    }
     ...
     *             a communication error.
     */
    public IoFilterQueryIssueResult queryIoFilterIssues(String filterId, ComputeResource cluster)
                    throws RemoteException, RuntimeFault {
        return getVimService().queryIoFilterIssues(getMOR(), filterId, cluster == null ? null : cluster.getMOR());
    }
}
