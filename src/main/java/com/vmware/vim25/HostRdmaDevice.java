...
public class HostRdmaDevice extends DynamicData {
    ...
    @Getter @Setter public String device;
    @Getter @Setter public String driver;
    @Getter @Setter public String description;
    @Getter @Setter public HostRdmaDeviceBacking backing;
    @Getter @Setter public HostRdmaDeviceConnectionInfo connectionInfo;
    @Getter @Setter public HostRdmaDeviceCapability capability;
}
