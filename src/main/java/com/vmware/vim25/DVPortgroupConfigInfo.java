...
public class DVPortgroupConfigInfo extends DynamicData {
    ...
    @Getter @Setter public String backingType;
    ...
    @Getter @Setter public String transportZoneUuid;
    @Getter @Setter public String transportZoneName;
    @Getter @Setter public String logicalSwitchUuid;
    @Getter @Setter public String segmentId;
    @Getter @Setter public String subnetId;
}
