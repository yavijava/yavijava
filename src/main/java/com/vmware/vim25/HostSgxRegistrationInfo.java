...
public class HostSgxRegistrationInfo extends DynamicData {
    ...
    @Getter @Setter public Integer biosError;
    @Getter @Setter public String registrationUrl;
    @Getter @Setter public String type;
    @Getter @Setter public String ppid;
    @Getter @Setter public Calendar lastRegisteredTime;
}
