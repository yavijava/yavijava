...
public class ArrayOfVASAStorageArrayDiscoverySvcInfo implements java.io.Serializable {
    ...
    public VASAStorageArrayDiscoverySvcInfo getVASAStorageArrayDiscoverySvcInfo(int i) {
        return this.VASAStorageArrayDiscoverySvcInfo[i];
    }

    public void setVASAStorageArrayDiscoverySvcInfo(VASAStorageArrayDiscoverySvcInfo[] VASAStorageArrayDiscoverySvcInfo) {
        this.VASAStorageArrayDiscoverySvcInfo = VASAStorageArrayDiscoverySvcInfo;
    }
}
