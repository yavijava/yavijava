...
public class ArrayOfVimVasaProviderStatePerArray {
    ...
    public VimVasaProviderStatePerArray getVimVasaProviderStatePerArray(int i) {
        return this.VimVasaProviderStatePerArray[i];
    }

    public void setVimVasaProviderStatePerArray(VimVasaProviderStatePerArray[] VimVasaProviderStatePerArray) {
