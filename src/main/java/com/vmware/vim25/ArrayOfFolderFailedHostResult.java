...
public class ArrayOfFolderFailedHostResult {
    ...
    public FolderFailedHostResult getFolderFailedHostResult(int i) {
        return this.FolderFailedHostResult[i];
    }

    public void setFolderFailedHostResult(FolderFailedHostResult[] FolderFailedHostResult) {
        this.FolderFailedHostResult = FolderFailedHostResult;
    }
}
