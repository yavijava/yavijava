...
public class GuestOsDescriptor extends DynamicData {
    ...
    @Getter @Setter public Boolean persistentMemorySupported;
    @Getter @Setter public Long supportedMinPersistentMemoryMB;
    @Getter @Setter public Long supportedMaxPersistentMemoryMB;
    @Getter @Setter public Long recommendedPersistentMemoryMB;
    @Getter @Setter public Boolean persistentMemoryHotAddSupported;
    @Getter @Setter public Boolean persistentMemoryHotRemoveSupported;
    @Getter @Setter public Boolean persistentMemoryColdGrowthSupported;
    @Getter @Setter public Long persistentMemoryColdGrowthGranularityMB;
    @Getter @Setter public Boolean persistentMemoryHotGrowthSupported;
    @Getter @Setter public Long persistentMemoryHotGrowthGranularityMB;
    @Getter @Setter public Integer numRecommendedPhysicalSockets;
    @Getter @Setter public Integer numRecommendedCoresPerSocket;
    @Getter @Setter public BoolOption vvtdSupported;
    @Getter @Setter public BoolOption vbsSupported;
    @Getter @Setter public BoolOption vsgxSupported;
    @Getter @Setter public Boolean vsgxRemoteAttestationSupported;
    @Getter @Setter public Boolean supportsTPM20;
    @Getter @Setter public Boolean recommendedTPM20;
    @Getter @Setter public Boolean vwdtSupported;
}
