...
public class ArrayOfClusterIoFilterInfo implements java.io.Serializable {
    ...
    public ClusterIoFilterInfo getClusterIoFilterInfo(int i) {
        return this.ClusterIoFilterInfo[i];
    }

    public void setClusterIoFilterInfo(ClusterIoFilterInfo[] ClusterIoFilterInfo) {
