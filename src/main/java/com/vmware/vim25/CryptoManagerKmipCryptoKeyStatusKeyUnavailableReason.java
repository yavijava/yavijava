...
public enum CryptoManagerKmipCryptoKeyStatusKeyUnavailableReason {
    ...
    NoPermissionToAccessKeyProvider("NoPermissionToAccessKeyProvider"),
    WrappingKeyMissingInKMS("WrappingKeyMissingInKMS"),
    WrappingKeyNotActiveOrEnabled("WrappingKeyNotActiveOrEnabled");

    private String val;

    CryptoManagerKmipCryptoKeyStatusKeyUnavailableReason(String val) {
        this.val = val;
    }
