...
public class ArrayOfVsanHostDiskMapInfo implements java.io.Serializable {
    ...
    public VsanHostDiskMapInfo[] VsanHostDiskMapInfo;

    public VsanHostDiskMapInfo[] getVsanHostDiskMapInfo() {
        return this.VsanHostDiskMapInfo;
    }

    public VsanHostDiskMapInfo getVsanHostDiskMapInfo(int i) {
        return this.VsanHostDiskMapInfo[i];
    }

    public void setVsanHostDiskMapInfo(VsanHostDiskMapInfo[] VsanHostDiskMapInfo) {
