...
public class ArrayOfHostLowLevelProvisioningManagerFileReserveSpec {
    ...
    public HostLowLevelProvisioningManagerFileReserveSpec getHostLowLevelProvisioningManagerFileReserveSpec(int i) {
        return this.HostLowLevelProvisioningManagerFileReserveSpec[i];
    }

    public void setHostLowLevelProvisioningManagerFileReserveSpec(HostLowLevelProvisioningManagerFileReserveSpec[] HostLowLevelProvisioningManagerFileReserveSpec) {
