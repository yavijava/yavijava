...
public class ArrayOfHostNvmeController {
    ...
    public HostNvmeController getHostNvmeController(int i) {
        return this.HostNvmeController[i];
    }

    public void setHostNvmeController(HostNvmeController[] HostNvmeController) {
        this.HostNvmeController = HostNvmeController;
    }
}
