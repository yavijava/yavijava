...
public class ArrayOfFileLockInfo implements java.io.Serializable {
    private static final long serialVersionUID = 1L;
    public FileLockInfo[] FileLockInfo;

    public FileLockInfo[] getFileLockInfo() {
        return this.FileLockInfo;
    }

    public FileLockInfo getFileLockInfo(int i) {
        return this.FileLockInfo[i];
    }
