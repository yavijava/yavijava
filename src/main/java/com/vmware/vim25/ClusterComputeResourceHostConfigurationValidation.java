...
public class ClusterComputeResourceHostConfigurationValidation extends ClusterComputeResourceValidationResultBase {
    ...
    @Getter @Setter public Boolean isDvsSettingValid;
    @Getter @Setter public Boolean isVmknicSettingValid;
    @Getter @Setter public Boolean isNtpSettingValid;
    @Getter @Setter public Boolean isLockdownModeValid;
}
