...
public class ArrayOfGuestRegKeyRecordSpec {
    ...
    public GuestRegKeyRecordSpec getGuestRegKeyRecordSpec(int i) {
        return this.GuestRegKeyRecordSpec[i];
    }

    public void setGuestRegKeyRecordSpec(GuestRegKeyRecordSpec[] GuestRegKeyRecordSpec) {
